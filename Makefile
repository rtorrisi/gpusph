...
# files to store last compile options: dbg, compute, fastmath, MPI usage, Chrono, linearization preference
...
# and definitions such as M_PI when including <cmath>
...
# compile GPU objects
$(CUOBJS): $(OBJDIR)/%$(OBJ_EXT): $(SRCDIR)/%.cu $(DEPDIR)/%.d | $(OBJSUBS)
